...
<h3 class="price" style="text-align: center;font-family:Courier New,Courier,monospace;font-style: Bold;color : white ;font-size : 250%;  background-color: black;padding-left: 20px;padding-right: 20px;font-size: 120%;">Our Price : <?= $product['cameraActualPrice']; ?></h4>
